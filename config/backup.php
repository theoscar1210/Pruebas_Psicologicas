    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                // Solo se respaldan archivos subidos por usuarios.
                // El código fuente no se incluye (está en git).
                'include' => [
                    storage_path('app'),
                ],
        ...
        'destination' => [
            ...
            // Disco local siempre activo.
            // Para agregar S3 cifrado: añadir 's3' aquí y configurar
            // AWS_* en .env + disco 's3' en config/filesystems.php.
            'disks' => array_filter([
                'local',
                env('BACKUP_S3_DISK'), // null = ignorado por array_filter
            ]),
        ],
