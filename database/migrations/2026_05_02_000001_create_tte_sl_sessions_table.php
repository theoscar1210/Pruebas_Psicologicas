...
return new class extends Migration
{
    ...
    {
        Schema::create('tte_sl_sessions', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedSmallInteger('m2_score')->nullable(); // 0–200 (todos los ítems 21–60)
            ...
            // Resultados finales
            $table->unsignedSmallInteger('total_score')->nullable(); // 0–275
            $table->json('dimension_scores')->nullable();            // {"C1":xx,"C2":xx,...}
    ...
    {
        Schema::dropIfExists('tte_sl_sessions');
    }
};
