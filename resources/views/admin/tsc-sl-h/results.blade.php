...
@section('title', 'TSC-SL Hospitalidad — Resultados')
@section('header', 'TSC-SL Hospitalidad · Resultados')
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
    ...
    <div class="lg:col-span-2 space-y-5">
        ...
        <div class="card">
            <div class="card-body">
                <div class="flex items-start justify-between flex-wrap gap-4 mb-5">
                    <div>
                        <h2 class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-1">Resultado final — TSC-SL Hospitalidad</h2>
        ...
        <div class="card">
            <div class="card-body">
                <h2 class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-4">Calificación Módulo 3 — Escenarios Hospitalidad</h2>
                @php
                $scTitles = [
                    1 => 'Pareja de aniversario — filete y teatro',
                    2 => 'Evento corporativo — plato no disponible',
                    3 => 'Cierre de turno — error de cobro',
                ];
                @endphp
                <div class="space-y-5">
                    @foreach([1,2,3] as $n)
